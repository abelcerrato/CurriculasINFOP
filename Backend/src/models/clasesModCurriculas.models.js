...
export const postClasesModulosCurriculasM = async (clase, duracionteorica, duracionpractica, duraciontotal, idcurricula, idmodulo, creadopor ) => {
    try {
        const { rows } = await pool.query(`
            ...
            [clase, duracionteorica, duracionpractica, duraciontotal, idcurricula, idmodulo, creadopor]);
        return rows;
    } catch (error) {
        throw error;
    }
